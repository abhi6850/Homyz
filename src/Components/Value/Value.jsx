        ...
        <section className="v-wrapper">
            <div className="paddings innerWidth flexCenter v-container">
                ...
                <div className="v-right flexColStart">
                    ...
                    <span className="secondaryText">We always ready to help you by providing the best services for you. <br />
                        We believe in a good place to live can make your life better</span>
                                ...
                                <AccordionItem key={i} uuid={i}>
                                    <AccordionItemHeading>
                                        <AccordionItemState>
                                            {({ expanded }) => (
                                                <AccordionItemButton
                                                    className={`accordionButton flexCenter ${expanded ? "expanded" : "collapsed"}`}
                                                >
